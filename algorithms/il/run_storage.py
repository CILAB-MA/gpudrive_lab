...
def arg_parse():
    ...
    parser.add_argument("--total_file_count", type=int, default=10)
    parser.add_argument("--learn_file_count", type=int, default=10)
    ...
    parser.add_argument('--save_path', type=str, default='/data/RL/data/train_subset')
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(args.world_start_index, total_file_count // learn_file_count)):
        ...
        command = f"CUDA_VISIBLE_DEVICES={gpu_index} {args.python_path} {args.store_path} --num_worlds {learn_file_count} --num_stack {args.num_stack} --save_index {save_index} --save_path {args.save_path} --dataset {args.dataset}"
