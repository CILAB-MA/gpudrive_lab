...
matplotlib.use('Agg')
# GPUDrive
from gpudrive.integrations.rl.linear_probing.dataloader import FutureDataset
from gpudrive.integrations.rl.linear_probing.lp_model import *
...
def train(exp_config=None):
    ...
    while gradient_steps < exp_config.total_gradient_steps:
        ...
        for i, batch in enumerate(expert_data_loader):
            ...
            obs, _, valid_mask, future_mask, future_pos = batch
            
            obs = obs.to("cuda").squeeze(1)
