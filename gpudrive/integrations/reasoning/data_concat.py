...
def run(save_path, save_name, subset_path, num_scenes, start_idx):
    ...
    for (reasoning_data) in tqdm(reasoning_datas):
        ...
        reasoning_data_path = os.path.join(subset_path + '/reasoning_final', reasoning_data)
...
if __name__ == "__main__":
    ...
    subset_path = f"/data/full_version/processed/final/reasoning_{args.dataset}_subset"
